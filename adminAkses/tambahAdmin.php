            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block">
                        <img src="../aset/gta.jpg" alt="">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1>forHealth <sup>+</sup></h1>
                                <h1 class="h4 text-gray-900 mb-4">Tambahkan Admin</h1>
                            </div>

                            <form action="prosesTA.php" method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <select name="level" class="form-select form-control border" aria-label=".form-select-sm example" required>
                                        ...
                                        <?php
                                        include "../connection.php";
                                        $queryAdmin = mysqli_query($conn, "SELECT level FROM admin");
                                        if ($level = mysqli_fetch_array($queryAdmin)) {
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="submit" name="simpan" value="Tambah Admin" class="btn btn-primary btn-user btn-block">
                                    </div>
                                </div>
                                <hr>
                            </form>
