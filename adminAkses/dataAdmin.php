        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4"> Berikut adalah daftar Admin yang bertugas di rumah sakit forHealth <sup>+</sup></p>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="editAdmin.php?idAdmin= <?= $dataAdmin['idAdmin'] ?>">
                                                        <img id="edit" src="../aset/edit.png" alt="">
                                                    </a> |
                                                    <a href="hapusAdmin.php?idAdmin= <?= $dataAdmin['idAdmin'] ?>" onclick="return confirm ('Apakah anda yakin menghapus data ini')">
