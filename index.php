          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login">
                <img src="aset/index.jpg" alt="" />
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <!-- <h1 class="h4 text-gray-900 mb-4">forHealth<sup>+</sup></h1>  -->
                  ...
                  <form action="cekLogin.php" method="POST" class="user">
                    ...
                    <a href="adminAkses/pasien/registrasi.php" class="btn btn-success btn-user btn-block">
                      Register
                    </a>
                  </form>
                  ...
                  <hr />
                  <div class="text-center">
                    <a class="small" href="#">Project by </a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="#">M. Yoga Kurniawan | 21510011</a>
                  </div>
                </div>
              </div>
            </div>
